...
router.get('/reports/pdf', validateTimeRange, validateReportTimeRange, async (req, res, next) => {
  try {
    const { timeRange = '24h' } = req.query;
...
router.get('/reports/excel', validateTimeRange, validateReportTimeRange, async (req, res, next) => {
  try {
    const { timeRange = '24h' } = req.query;
