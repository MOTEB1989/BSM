...
/**
 * json_to_md.js — Converts BSM agent JSON reports to Markdown.
 *
 * Usage:
...
const title = data.title || `BSM Agents Report — ${timestamp}`;
...
md.push("---");
md.push("");
md.push("*Report generated by BSM Enterprise Reporting Pipeline*");
md.push("");
