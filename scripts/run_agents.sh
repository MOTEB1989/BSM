#!/usr/bin/env bash
# ===========================================================================
# BSM Enterprise Reporting Pipeline — Agent Runner
# ===========================================================================
# Usage:
...
{
  "timestamp": "${TIMESTAMP}",
  "title": "BSM Agents Report — ${TIMESTAMP}",
  "agents": [],
  "summary": {}
}
JSONEOF
...
echo "# BSM Agents Run Report — ${TIMESTAMP}" > "${SUMMARY_OUT}"
echo "" >> "${SUMMARY_OUT}"
